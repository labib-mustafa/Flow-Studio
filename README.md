...
> **All-in-One Design, Moodboard & Project Management Desktop Suite**  
> A fast, local-first hybrid desktop application built with React 19, TypeScript, Electron, and Express.
...
npm run dev
```
*(On Windows, you can also double-click `Start Dev Mode.bat` or `Start Flow Studio.bat`)*
...
* **Local Data**: App data is automatically saved in `~/Documents/FlowStudio-Data/` as clean JSON files.

...
import { Edit2, CheckCircle, MessageSquare, Trash2 } from 'lucide-react';
    ...
    >
      <div className="h-48 relative overflow-hidden bg-slate-100 flex items-center justify-center">
         {image ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col items-center justify-center text-slate-400 group-hover:from-slate-100 group-hover:to-slate-200 transition-all duration-300">
               <span className="material-symbols-outlined text-3xl text-slate-300 mb-1.5">image</span>
               <span className="text-[9px] font-bold uppercase tracking-wider text-slate-400">No Banner Image</span>
            </div>
         )}
          ...
          <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1.5">
             {onEditClick && (
                <button 
                   ...
                   className="p-1.5 bg-white/90 backdrop-blur-sm rounded-lg text-slate-600 hover:text-blue-600 hover:bg-white shadow-sm transition-colors"
                   title="Edit project"
                >
             ...
             {onDeleteClick && (
                <button 
                   ...
                   className="p-1.5 bg-white/90 backdrop-blur-sm rounded-lg text-slate-600 hover:text-red-600 hover:bg-white shadow-sm transition-colors"

...
import { ProjectSidebar } from './GlobalComponents/ProjectSidebar';
...
export const ProjectDetailsLayout: React.FC<ProjectDetailsLayoutProps> = ({ onBack, currentTab, onTabChange, children, isSidebarExpanded = false, onSidebarToggle }) => {
  return (
    <div id="project-details-layout" className="flex h-full bg-[#f5f5f7] overflow-hidden relative">
      ...
      {/* Global Sidebar */}
      <ProjectSidebar isExpanded={isSidebarExpanded} onToggle={onSidebarToggle} />
    </div>
  );
};

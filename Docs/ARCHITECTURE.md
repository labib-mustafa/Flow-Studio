...
| **ADR-003** | State-Based View Router | Internal state in `App.tsx` over `react-router` | Eliminates browser history conflicts inside the Electron desktop shell and enables instant view recovery. |

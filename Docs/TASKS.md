...
Autonomous AI assistant for design synthesis and task creation. `[2/3 completed]`

| # | Task | Priority | Status | Notes |
|:---:|:---|:---:|:---:|:---|
| 9.1 | Implement `AGENTS.md` protocol & task schemas | `High` | `Completed` | Structured rules for note parsing and task creation |
| 9.2 | In-app AI Co-Pilot drawer & Gemini 3.6 engine | `High` | `Completed` | Google GenAI SDK integration with Gemini 3.6 Flash & Pro |
